				...
				<div class="spec_table">
					...
					<div class="spec_table_row">
						...
						<div class="spec_table_spec">
							...
							<span class="spec_table_item">pOLED</span>
							<span class="spec_table_item">18:9</span>
						</div>
					</div>
					<div class="spec_table_row">
						...
						<div class="spec_table_spec">
							<div class="spec_table_subtable">
								<h5>Rear Camera</h5>
								<span class="spec_table_item">12.2 MP</span>
								<span class="spec_table_item">1.4 &micro;m</span>
								<span class="spec_table_item">Laser + phase detection autofocus</span>
								<span class="spec_table_item">Optical + electronic image stablization</span>
								<span class="spec_table_item">f/1.8 aperture</span>
							</div>
							<div class="spec_table_subtable">
								<h5>Front Camera</h5>
								<span class="spec_table_item">8 MP</span>
								<span class="spec_table_item">1.4 &micro;m</span>
								<span class="spec_table_item">Fixed focus</span>
								<span class="spec_table_item">No stabilization</span>
								<span class="spec_table_item">f/2.4 aperture</span>
							</div>
							<div class="spec_table_subtable">
								<h5>Rear Camera Video</h5>
								<span class="spec_table_item">1080p @ 30fps, 60fps, 120fps</span>
								<span class="spec_table_item">720p @ 30fps, 60fps, 240fps</span>
								<span class="spec_table_item">4k @ 30fps</span>
							</div>
							<div class="spec_table_subtable">
								<h5>Front Camera Video</h5>
								<span class="spec_table_item">1080p @ 30fps</span>
								<span class="spec_table_item">720p @ 30fps</span>
								<span class="spec_table_item">480p @ 30fps</span>
							</div>
						</div>
					</div>
					<div class="spec_table_row">
						...
						<div class="spec_table_spec">
							...
							<span class="spec_table_item">Ardeno 540</span>
						</div>
					</div>
					<div class="spec_table_row">
					...
					<div class="spec_table_row">
						...
						<div class="spec_table_spec">
							...
							<span class="spec_table_item">Nano SIM</span>
						</div>
					</div>
					<div class="spec_table_row">
